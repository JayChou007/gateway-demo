package com.ruoyi.gateway.refresh;
...
/**
 * @ClassName GatewayPropertiesRefresh
 * @Description 动态刷新gateway配置信息
 * @Author Kevin
 * @Date 2022/01/05 17:17
 */
@Component
public class GatewayPropertiesRefresh implements ApplicationContextAware, ApplicationEventPublisherAware {

    private static final Logger logger = LoggerFactory.getLogger(GatewayPropertiesRefresh.class);
